...
- [ ] 4.0 OpenStreetMap 연동 및 지도 시스템 구축 (Push 단위)
    ...
    - [ ] 4.3 마커 관리 시스템 (커밋 단위)
        ...
        - [ ] 4.3.3 커스텀 마커 아이콘 구현[6]
            - [ ] 4.3.3.1 `L.Icon` 또는 `L.DivIcon`으로 커스텀 아이콘 생성
            - [ ] 4.3.3.2 안전구역 마커 (초록색 아이콘)
            - [ ] 4.3.3.3 위험구역 마커 (빨간색 아이콘)
            - [ ] 4.3.3.4 어업권 마커 (파란색 아이콘)
            - [ ] 4.3.3.5 테스트 코드 작성
            - [ ] 4.3.3.6 테스트 실행 및 검증
            - [ ] 4.3.3.7 오류 수정 (필요 시)
        - [ ] 4.3.4 마커 클릭 이벤트 (Popup 표시)[7]
            - [ ] 4.3.4.1 `eventHandlers` prop로 클릭 이벤트 처리
            - [ ] 4.3.4.2 Popup 컴포넌트로 정보 표시
            - [ ] 4.3.4.3 테스트 코드 작성
            - [ ] 4.3.4.4 테스트 실행 및 검증
            - [ ] 4.3.4.5 오류 수정 (필요 시)
