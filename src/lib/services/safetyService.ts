...
export async function analyzeSafety(
    ...
    if (weather) {
        ...
        if (maxWind >= 25) {
            applyDeduction(50, 'weather', deductions, scoreRef);
            ...
            applyDeduction(35, 'weather', deductions, scoreRef);
            addRisk(risk_factors, {
                type: 'WEATHER',
                severity: 'HIGH',
        ...
        if (waveHeight >= 2.5) {
            applyDeduction(35, 'sea', deductions, scoreRef);
            addRisk(risk_factors, {
                type: 'WEATHER',
                severity: 'HIGH',
            ...
            applyDeduction(20, 'sea', deductions, scoreRef);
            addRisk(risk_factors, {
                type: 'WEATHER',
                severity: 'MEDIUM',
        ...
        if (swell >= 1.2) {
            ...
            applyDeduction(8, 'sea', deductions, scoreRef);
        }
    } else {
    ...
    if (nearestDistance === undefined) {
        ...
        applyDeduction(20, 'response', deductions, scoreRef);
        addRisk(risk_factors, {
            type: 'OTHER',
            severity: 'HIGH',
        ...
        applyDeduction(12, 'response', deductions, scoreRef);
    ...
    if (hour < 6 || hour >= 18) {
        applyDeduction(25, 'activity', deductions, scoreRef);
        addRisk(risk_factors, {
            type: 'OTHER',
            severity: 'HIGH',
